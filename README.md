...
body {
  ...
  color: #f5f5f5; /* Light gray text color for better readability */
...
.container {
  background: rgba(0, 0, 0, 0.75); /* Slightly less opaque for a subtle effect */
  border-radius: 15px; /* More rounded corners for a modern look */
  padding: 30px;
  max-width: 800px;
  margin: 50px auto;
  box-shadow: 0 6px 12px rgba(0, 0, 0, 0.6); /* Deeper shadow for more depth */
...
h3 {
  font-size: 1.7em;
  margin-bottom: 25px;
  color: #b0b0b0; /* Slightly darker gray for sub-headers */
  transition: color 0.3s ease;
}
...
form input[type="email"] {
  ...
  margin: 8px;
  width: calc(50% - 24px);
  background-color: rgba(255, 255, 255, 0.15); /* Slightly transparent white for inputs */
  color: #f5f5f5; /* Text color in inputs */
  transition: background-color 0.3s ease, border-color 0.3s ease, box-shadow 0.3s ease;
}

form input[type="text"]:focus,
form input[type="email"]:focus {
  background-color: rgba(255, 255, 255, 0.25); /* Darker background on focus */
  border-color: #007BFF; /* Highlight border color on focus */
  box-shadow: 0 0 8px rgba(0, 123, 255, 0.5); /* Subtle shadow on focus */
}
...
form button:hover {
  ...
  box-shadow: 0 4px 12px rgba(0, 123, 255, 0.3); /* Subtle shadow on hover */
}
...
table th, table td {
  padding: 12px;
  border: 1px solid #555; /* Darker border color for table cells */
  transition: background-color 0.3s ease, color 0.3s ease;
}

table th {
  background-color: rgba(0, 0, 0, 0.65); /* Darker background for table headers */
  color: #e0e0e0; /* Light gray text color for headers */
}

table td {
  background-color: rgba(0, 0, 0, 0.55); /* Slightly lighter background for table cells */
}
...
table button.editar {
  background-color: #28a745; /* Green for edit buttons */
}
